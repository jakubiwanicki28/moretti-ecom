...
document.addEventListener('DOMContentLoaded', function() {
    ...
    */
    ...
    if (morettiDotDebug) {
        ...
        wrap.setAttribute('style', 'position:fixed !important; right:auto !important; left:0 !important; top:80px !important; bottom:140px !important; width:min(320px,45vw) !important; z-index:999990; background:#1a1a1a; color:#0f0; font:12px/1.4 monospace; padding:8px 12px; overflow:auto; border-right:2px solid #0f0; border-radius:0 4px 4px 0; box-shadow:4px 0 12px rgba(0,0,0,0.2);');
