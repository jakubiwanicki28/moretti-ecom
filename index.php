...
<section class="grid grid-cols-1 md:grid-cols-2 h-[80vh]">
    ...
    <div class="relative group overflow-hidden flex items-center justify-center">
        <img src="<?php echo get_template_directory_uri(); ?>/images/men-wallets.jpg" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Dla Niego">
    ...
    <div class="relative group overflow-hidden flex items-center justify-center border-l border-white/10">
        <img src="<?php echo get_template_directory_uri(); ?>/images/woman-holding-wallet.png" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Dla Niej">
        <div class="absolute inset-0 bg-black/30"></div>
        <div class="relative z-10 text-center">
...
<div class="container mx-auto px-4">
    <div class="flex flex-col items-center text-center mb-12">
        <span class="text-[10px] uppercase tracking-[0.3em] text-taupe-500 mb-2">Wkrótce w sprzedaży</span>
...
<section class="container mx-auto px-4 py-20">
    <div class="bg-charcoal text-white p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div class="relative z-10 max-w-2xl">
            <span class="text-[10px] uppercase tracking-[0.4em] mb-4 block font-medium text-taupe-400">Limited Edition</span>
...
<div class="absolute inset-0 z-0">
    <img src="<?php echo get_template_directory_uri(); ?>/images/men-wallets.jpg" class="w-full h-full object-cover" alt="Icons">
...
<!-- 10. DESTINATION FOR EXQUISITE FASHION (Screenshot 7) -->
<section class="container mx-auto px-4 py-20">
<div class="grid md:grid-cols-2 gap-16 items-center">
    ...
    <div>
        <img src="<?php echo get_template_directory_uri(); ?>/images/woman-holding-wallet.png" class="w-full h-auto grayscale" alt="Fashion">
    </div>
</div>
</section>
